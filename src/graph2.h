...
bool adjlist_is_balanced(const adjlist *g);

/** Add an edge between vertices 'u' and 'v' with weight. O(1), worst-case O(|N|). */
void adjlist_add_edge(adjlist *g, int u, int v, double weight);

/** Add an edge between vertices 'u' and 'v' and vice-versa. */
void adjlist_add_sym_edges(adjlist *g, int u, int v, double weight);

/** Remove the edge between vertices 'u' and 'v'. */
bool adjlist_rmv_edge(adjlist *g, int u, int v);
