...
{
    v->array = (void*)realloc(v->array, new_capacity * sizeof(int));
}

O_INLINE void ivector_grow1(ivector *v)
{
...
O_INLINE void ivector_sort_asc(ivector *v)
{
    qsort((void*)v->array, v->size, sizeof(int), compare_int_asc);
}

O_INLINE void ivector_sort_des(ivector *v)
{
...
O_INLINE void ivector_free(ivector *v)
{
